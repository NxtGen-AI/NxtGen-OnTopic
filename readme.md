...
1. Open command palette \\ ![Open command palette](image.png)
2. Search and select `Python: create environment`\\ ![Python: create environment](image-1.png)
3. Choose `venv` \\ ![venv](image-2.png)
4. Choose interpreter path \\ ![interpreter](image-3.png)
5. Select `requirements.txt` and click OK \\ ![requirements.txt](image-4.png)
